...
describe('SignUpComponent', () => {
  ...
  describe('Interactions', ()=>{
    ...
    const setupForm = () =>{
      ...
      emailInput.value = "faraz@gmail.com";
    ...
    it('sends username, email, and passwords after clicking the signup button', ()=>{
      setupForm();
      button?.click();
    ...
    it('disables the button when there is an ongoing api call', ()=>{
      setupForm();
      button?.click();
      fixture.detectChanges();
      button.click();
    ...
    it('displays account activation notification after successful request', ()=>{
      setupForm();
